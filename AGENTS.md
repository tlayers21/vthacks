...
records money movement; our own database owns balances and everything else -- the sandbox
never updates a balance (see `docs/spec.md` §6). Full spec: `docs/spec.md`.
